...
class Helper_MCC {
	...
	private static $mcc_rus = array(
		...
		4814 => 'Телекоммуникационные услуги',//'Звонки с использованием телефонов, считывающих магнитную ленту, “телекоммуникационные услуги”',
		4816 => 'Компьютерная сеть/ информационные услуги',
		4821 => 'Услуги телеграфа',
		4829 => 'Денежные переводы, (покупка валюты, дорожных чеков, переводы с карты на другую карту или счет, не в финансовых учреждениях – через интернет, банкомат, “квази-кэш”, можно попасть на комиссию и/или даже вылететь и грейс-периода для кредиток)',
        ...
        5047 => 'Стоматологическое/лабораторное/медицинское/офтальмологическое стационарное оборудование и устройства',
		...
		5085 => 'Промышленное оборудование',
		5094 => 'Драгоценные камни и металлы, часы и ювелирные изделия',
		5099 => 'Товары длительного пользования',
		...
		5139 => 'Спец-обувь',
		5169 => 'Химикалии и смежные вещества',
		5172 => 'Нефть и нефтепродукты',
		5192 => 'Книги, периодические издания и газеты',
		5193 => 'Оборудование для выращивания растений, инвентарь для питомников и цветы',
		5198 => 'Лакокрасочная продукция и сопровождающие товары',
		5199 => 'Товары недлительного пользования',
		...
		5441 => 'Кондитерские',
		5451 => 'Продажа молочных продуктов',
		5462 => 'Булочные',
		...
		5541 => 'АЗС', //'СТО (с дополнительными услугами или без)',
		...
		5599 => 'Продажа различного рода автомобилей, авиа- и с/х оборудования',
		5611 => 'Мужская одежда и аксессуары',
		...
		5712 => 'Оборудование, мебель и бытовые принадлежности',
		...
		5813 => 'Бары, коктейль-бары, дискотеки, ночные клубы и таверны',
		...
		5932 => 'Антикварные Магазины',
		5933 => 'Ломбарды',
		5935 => 'Магазины сбора и использования утиль сырья',
		5937 => 'Магазины продажи репродукций и антиквариата',
		5940 => 'Веломагазины',
		5941 => 'Магазины Спорттоваров',
		5942 => 'Книжные магазины',
		5943 => 'Канцтовары',
		5944 => 'Часы, ювелирные изделия',
		5945 => 'Магазины игрушек',
		5946 => 'Фотооборудование и фотоприборы',
		5947 => 'Открытки, подарки, сувениры',
		...
		5983 => 'АЗС', //'Горючее топливо – уголь, нефть, разжиженный бензин, дрова',
		5992 => 'Флористика',
		...
		6010 => 'Снятие наличности', // Финансовые институты – снятие наличности вручную
		...
		6399 => 'Страхование',
		6513 => 'Real Estate Agents and Managers – Rentals',
		6536 => 'Денежные переводы MasterCard MoneySend',
		...
		7392 => 'Консультация, мэнеджмент, паблик-рилэйшн услуги',
		7393 => 'Детективные, охранные агенства',
		7394 => 'Сдача в аренду оборудования, мебели, инструментов',
		7395 => 'Фотостудии, фотолаборатории',
		7399 => 'Бизнес – сервис',
		7511 => 'Прокат автомобилей',
		...
		7531 => 'СТО для автомобильного транспорта',
		...
		7623 => 'Ремонт и запрака кондиционеров и холодильников',
		...
		7995 => 'Транзакции по Азартным играм, казино (в том, числе интернет)',
		7996 => 'Луна-парки, Карнавалы, Цирки, Предсказатели будущего',
		7997 => 'Клубы',
		7998 => 'Аквариумы, Дельфинариумы, Зверинцы, и Морские парки',
		7999 => 'Услуги Отдыха',
		8011 => 'Доктора',
		...
		8099 => 'Практикующие врачи, Медицинские Услуги',
		...
		8244 => 'Бизнес и школы секретарей',
		...
		8699 => 'Организации, Членство',
		8734 => 'Испытательные Лаборатории (не медицинские)',
		...
		9402 => 'Почтовые Услуги – US',
		9405 => 'Внутриправительственные Закупки - US',
    ...
    public static function get_rus($code) {
		if (isset(self::$mcc_rus[self::rus_correct($code)]))
			return self::$mcc_rus[self::rus_correct($code)];
		if (isset(self::$mcc_eng[$code]))
			return self::$mcc_eng[$code];
		return 'MCC не определен';
    }
